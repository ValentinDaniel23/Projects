...
public class Regular extends User implements RequestsManager {
    public Regular(Information userInfo, int experience, AccountType accountType) {
        super(userInfo, experience, accountType);
    }
    public Regular(Information userInfo, int experience, AccountType accountType, String username) {
    ...
    public boolean createRequest(Request r)
    {
        ...
        if (r.getType() == RequestTypes.OTHERS || r.getType() == RequestTypes.DELETE_ACCOUNT) {
            List<Request> rrequest = Admin.RequestsHolder.getRequestsList();
